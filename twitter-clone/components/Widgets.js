  ...
  return (
    <div className='xl:w-[600px] hidden lg:inline ml-8 space-y-5'>
      <div className='w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50'>
        <div className='flex items-center p-3 rounded-full relative bg-gray-500'>
        ...
        <AnimatePresence>
          {randomUsersResults.slice(0, randomUserNum).map((randomUser) => (
            ...
            >
              <div
                key={randomUser.login.username}
                className='flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200 hover:rounded-xl transition duration-500 ease-out'
              >
                <img
